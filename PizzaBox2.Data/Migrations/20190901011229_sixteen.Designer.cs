...
namespace PizzaBox2.Data.Migrations
{
    ...
    [Migration("20190901011229_sixteen")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PizzaBox2.Domain.Models.Transaction", b =>
                {
                    b.HasOne("PizzaBox2.Domain.Models.Location", "L")
                        .WithMany()
                        .HasForeignKey("LId");

                    b.HasOne("PizzaBox2.Domain.Models.Order", "O")
                        .WithMany()
                        .HasForeignKey("OId");

                    b.HasOne("PizzaBox2.Domain.Models.User", "U")
                        .WithMany()
                        .HasForeignKey("UId");
                });
