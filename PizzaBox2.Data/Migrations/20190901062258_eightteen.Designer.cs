...
namespace PizzaBox2.Data.Migrations
{
    ...
    [Migration("20190901062258_eightteen")]
    partial class eightteen
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PizzaBox2.Domain.Recipes.CaliforniaPizza", b =>
                {
                    b.HasBaseType("PizzaBox2.Domain.Models.Pizza");

                    b.HasDiscriminator().HasValue("CaliforniaPizza");
                });

            modelBuilder.Entity("PizzaBox2.Domain.Recipes.PepperoniSupreme", b =>
                {
                    b.HasBaseType("PizzaBox2.Domain.Models.Pizza");

                    b.HasDiscriminator().HasValue("PepperoniSupreme");
                });
